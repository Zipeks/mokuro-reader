<script lang="ts">
  ...
  function rotateZoomMode() {
    ...
    // Rotate through: fitToScreen -> fitToWidth -> original -> keepZoom -> keepZoomStart -> keepZoomTopRight -> fitToScreen
    ...
    const labels = {
      ...
      keepZoomTopRight: 'Keep Zoom, Pan to Top-Right'
    };
